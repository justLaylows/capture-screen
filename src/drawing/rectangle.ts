import { CUTBOXINFO, OPTION, DRAWINGINFO,POSITIONINFO } from '../types/index'
...
class drawingRectangle {
  ...
  constructor() {
    ...
    this.drawingInfo = { clickX: 0, clickY: 0 }
    this.positionInfo = []
  }
  ...
  mouseMoveEvent(e:MouseEvent, ctx:CanvasRenderingContext2D, option:OPTION) {
    ...
    renderRectangle.draw(ctx, drawInfo)
  ...
  handleData(positionList:POSITIONINFO) {
...
export default new drawingRectangle()
